...
Himinn::ScoreComponent::ScoreComponent(const std::weak_ptr<GameObject>& owner, const shared_ptr<Font>& font, const SDL_Color& color)
	: Component(owner)
{
	...
	m_pTextComponent.lock()->SetText("Current score: 0");
}
